...
class AuthStateLoggedOut extends AuthState with EquatableMixin{ // distinguish 2 equal properties
  ...
  @override
  List<Object?> get props => [exception, isLoading]; // 2 properties to be taken into account
}
